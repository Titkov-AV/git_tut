...
//	while (flg);
	...
	/*  Маска рабочих каналов ввода. 255 - все каналы в работе */
//	EXTI_ClearFlag(0x7ffff); /* установка значений на сброс ложных прерываний по старту  */

    /* Set the Vector Table base  */
//	NVIC_SetVectorTable(0x08020000, 0);
